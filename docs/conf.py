# -*- coding: utf-8 -*-
#
# pytest-stubprocess documentation build configuration file, created by
...
project = u'pytest-stubprocess'
copyright = u'2015, Alex Thompson'
author = u'Alex Thompson'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-stubprocess Documentation',
     [author], 1)
]
